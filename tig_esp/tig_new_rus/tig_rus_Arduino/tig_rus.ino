...
pinMode(10, OUTPUT);     //  Выход на включения сварки ................................ /GPIO 10
pinMode(2, OUTPUT);      //  Выход на включения света ................................ /GPIO 2
pinMode(A0, INPUT);        //  Вход ADC датчика тока для контроля зажигания рабочей дуги  /ADC 0
pinMode(9, INPUT_PULLUP); //  Вход с педали старт сварки................................./GPIO 9
...
if (digitalRead(9)){digitalWrite(10, 0); svet=17 ;}else{digitalWrite(10, 1); }    // читаем gpio15 и включаем или выключаем дугу

break;
case 1://Режим холодной точечной сварки cold_tig

if (digitalRead(9)){i=1 ;svet=17;}else{i=0;start=0;}    //тригер кнопки старт срабатывает один раз при нажатии кнопки  
...
if (svet>2){digitalWrite(2, 1);svet=svet-1 ;}
else{digitalWrite(2, 0) ;svet=0;}
